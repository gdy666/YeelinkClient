...
public class ListViewDropFlush extends ListView implements OnScrollListener {
	...
	public ListViewDropFlush(Context context) {
		super(context);
		init(context);
	}

	public ListViewDropFlush(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
